...
<body>
    <div class="container">
        ...
        <!-- ปุ่มเข้าสู่ระบบด้วย LINE -->
        <button class="login-button" onclick="loginWithLine()">
        ...
        <!-- ข้อความช่วยเหลือ -->
        <div class="help-text">
            ไม่มีบัญชี LINE? <a href="#" class="help-link">วิธีสมัครบัญชี LINE</a>
        </div>
        ...
        <!-- Footer -->
        <div class="footer">
            &copy; 2025 STUDENT-Prasat. All rights reserved.
        </div>
    </div>
    ...
    <script>
        ...
        function loginWithLine() {
            ...
            // URL สำหรับเข้าสู่ระบบด้วย LINE
            let loginUrl = '';
            
            switch(role) {
                case 'student':
                    loginUrl = 'https://access.line.me/oauth2/v2.1/authorize?response_type=code&client_id=YOUR_CLIENT_ID&redirect_uri=YOUR_REDIRECT_URI&state=student&scope=profile%20openid';
                    break;
                case 'teacher':
                    loginUrl = 'https://access.line.me/oauth2/v2.1/authorize?response_type=code&client_id=YOUR_CLIENT_ID&redirect_uri=YOUR_REDIRECT_URI&state=teacher&scope=profile%20openid';
                    break;
                case 'parent':
                    loginUrl = 'https://access.line.me/oauth2/v2.1/authorize?response_type=code&client_id=YOUR_CLIENT_ID&redirect_uri=YOUR_REDIRECT_URI&state=parent&scope=profile%20openid';
                    break;
            }
            
            // เปิดหน้าต่างเข้าสู่ระบบด้วย LINE
